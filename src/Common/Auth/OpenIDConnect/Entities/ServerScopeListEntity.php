...
class ServerScopeListEntity
{
    ...
    public function lookupDescriptionForFullScopeString($scope)
    {
        $requiredSmart = [
            ...
            "api:oemr" => xlp('Permission to use the %s standard api.'),
            "api:fhir" => xlp('Permission to use the %s FHIR api'),
            "api:port" => xlp('Permission to use the %s apis from inside the patient portal'),
        ];
