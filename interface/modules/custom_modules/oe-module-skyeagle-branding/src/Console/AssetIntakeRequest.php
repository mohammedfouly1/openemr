 ...
 * the JSON file, before {@see \OpenEMR\Modules\SkyEagleBranding\AssetIntake\LogoValidator}
 * has looked at the bytes at `$sourcePath`. Only a {@see
 * \OpenEMR\Modules\SkyEagleBranding\Materialisation\AssetPlacement} built from the
