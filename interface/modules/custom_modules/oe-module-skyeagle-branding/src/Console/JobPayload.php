 ...
 * logger). {@see \OpenEMR\Modules\SkyEagleBranding\Console\MaterialiseCommand} owns a
...
final readonly class JobPayload
{
     ...
     * {@see \OpenEMR\Modules\SkyEagleBranding\Console\MaterialiseCommand::resolveAssets()})
