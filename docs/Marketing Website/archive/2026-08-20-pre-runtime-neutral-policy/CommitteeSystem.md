...
3. M0 runs §6.3 preflight and records model assignment, model observation, source access, output path,
...
| Models | Assigned model/tier and D3a result for every firing agent |
...
appends actual model observations, actual skills used, dispatch times, failures/retries, every agent's
