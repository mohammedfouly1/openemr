...
**Companion to `../MarketingWebsite.md` and `MarketingMethod.md`.** Created 2026-08-20 by transferring the tooling
...
| Trial funnel design | `plg-funnel-analyzer`, `onboarding-optimizer` | Directly relevant to the four self-serve challenges in `../03-website-plan/Challenges-and-Demo.md` §1–§4 |
...
literature — are credited in `MarketingMethod.md` §10–§12, where the method itself lives.
