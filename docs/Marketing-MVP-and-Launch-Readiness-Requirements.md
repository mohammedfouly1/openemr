...
| **0002** | Confirm `Product-Positioning-and-GTM-Locked-Strategy.md` 2026-08-11 is still the newest authoritative GTM, and record acceptance of VERDICT B | GTM §0, §35 | Version identified; **no acceptance record** | NOT READY — DOCUMENTATION | DOCUMENTATION | **P0** | G0 | Founder / Product Owner | — | NOT READY |
...
| **0082** | **Prove restore.** A backup produced by the documented procedure restores into a disposable instance; the application starts; authenticated login succeeds; defined row-count and checksum comparisons pass | GTM §25 Phase 2 gate; brief §23 | **Never tested** | NOT READY — OPERATIONAL | BACKUP / RESTORE | **P0** | G3 G6 | DevOps / Infrastructure | 0080, 0081, 0047 | NOT READY |
