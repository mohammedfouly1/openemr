...
| **9, 10, 14** | **RDY-0043** — the encounter-forms menu | **FIXED (PR-15, PB-052)** — **and it was far worse than recorded.** The menu rendered **0 of 16 forms**, not "the first in each category": Eye Exam, Vitals, SOAP, Fee Sheet, Procedure Order and New Questionnaire were **all** unreachable from it. Now 16 of 16 | **Steps 9, 10 and 14 depended on this and would have failed from the menu.** Verified fixed at the code path; **confirm in rehearsal 1 that each form opens from the encounter menu** |
