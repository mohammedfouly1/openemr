...
namespace OpenEMR\Tests\Isolated\Modules\ThiqaBranding\Accessibility;
...
/**
 * The custom_modules/oe-module-thiqa-branding module is not registered in the
...
final class ContrastCalculatorTest extends TestCase
{
    ...
    private const MODULE_SOURCE = '/interface/modules/custom_modules/oe-module-thiqa-branding/src/';
