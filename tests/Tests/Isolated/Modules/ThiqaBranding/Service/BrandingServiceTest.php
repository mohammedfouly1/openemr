...
namespace OpenEMR\Tests\Isolated\Modules\ThiqaBranding\Service;
...
use OpenEMR\Tests\Isolated\Modules\ThiqaBranding\Asset\FakeLogoService;
...
final class BrandingServiceTest extends TestCase
{
    private const TOKEN_STYLESHEET_URL =
        '/openemr/interface/modules/custom_modules/oe-module-thiqa-branding/public/branding-tokens.php';
