...
use OpenEMR\Modules\SkyEagleBranding\Console\ManagedBackupArtifact;
use OpenEMR\Modules\SkyEagleBranding\Console\ManagedBackupRetention;
...
final class BackupRetentionTest extends TestCase
{
    ...
    public function testCommandKeepsTheDeploymentDefaultButDelegatesNamingAndRetention(): void
    {
        ...
        $source = file_get_contents(
            dirname(__DIR__, 6)
            . '/interface/modules/custom_modules/oe-module-skyeagle-branding/src/Console/BackupCommand.php',
        );
