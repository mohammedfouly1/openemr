...
final class BrandingTemplateRenderTest extends TestCase
{
    ...
    private const NAMESPACE_NAME = 'oe-module-skyeagle-branding';

    private const MODULE_TEMPLATES = '/interface/modules/custom_modules/oe-module-skyeagle-branding/templates';
     ...
     * "@oe-module-skyeagle-branding/...", and the bare core name still resolves to the
