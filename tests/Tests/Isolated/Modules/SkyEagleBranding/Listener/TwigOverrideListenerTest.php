 ...
 *    `@oe-module-skyeagle-branding/...` form, because a namespaced template is unreachable by
 *    any other means.
 *
...
final class TwigOverrideListenerTest extends TestCase
{
    ...
    public static function variantTemplateProvider(): array
    {
        return [
            'dark' => [
                ThemeVariant::Dark,
                '@oe-module-skyeagle-branding/api/smart/smart-style_dark.json.twig',
            ],
            'light' => [
                ThemeVariant::Light,
                '@oe-module-skyeagle-branding/api/smart/smart-style_light.json.twig',
            ],
        ];
    }
    ...
    private function moduleTemplateDirectory(): string
    {
        return dirname(__DIR__, 6)
            . '/interface/modules/custom_modules/oe-module-skyeagle-branding/templates';
    }
}
