...
/**
 * Wiring guard for the four ThiqaBranding PHPStan guardrails
 *
 * @package   OpenEMR
 ...
 */
final class ThiqaBrandingRuleRegistrationTest extends TestCase
{
    ...
    private const FIXTURE_EXCLUDE_PATH = '../tests/Tests/Isolated/PHPStan/ThiqaBranding/data';
    ...
    {
        // The fixtures declare the ThiqaBranding namespace and violate every
        ...
        self::assertStringContainsString(
            ...
            $neon,
            'The ThiqaBranding fixture directory must stay in excludePaths.',
        );
    }
