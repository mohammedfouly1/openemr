...
final class ForbiddenBrandingTwigPathRuleTest extends RuleTestCase
{
    ...
    private const IDENTIFIER = 'skyeagleBranding.twigNamespaceDiscipline';
    ...
    {
        return 'FilesystemLoader::prependPath() is forbidden in SkyEagleBranding code: it registers an '
